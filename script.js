// access dom elements through getElementById method
var btn0 = document.getElementById('btnDown0');
...
// register event click callback function
btn0.addEventListener("click", function() {
    var i = 10;
    var int = setInterval(function() {
        // keep scrolling until reach window.innerHeight
        window.scrollTo(0, i);
        i += 15;
